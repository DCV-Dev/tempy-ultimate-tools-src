...
while True:
   ...
   print(f"""{popup_version}{red}                                                                                                  
                     ...
                     |_   _|__ _ __ ___  _ __  _   _  | | | | | |_(_)_ __ ___   __ _| |_ ___  |_   _|__   ___ | |___ 
                       | |/ _ \ '_ ` _ \| '_ \| | | | | | | | | __| | '_ ` _ \ / _` | __/ _ \   | |/ _ \ / _ \| / __|
                       | |  __/ | | | | | |_) | |_| | | |_| | | |_| | | | | | | (_| | ||  __/   | | (_) | (_) | \__ \
                           |_|\___|_| |_| |_| .__/ \__, |  \___/|_|\__|_|_| |_| |_|\__,_|\__\___|   |_|\___/ \___/|_|___/
                                        |_|    |___/                                                                 

                                           {white}https://discord.gg/CMeAqDG5Vw    
                                 {white}╔══════════════╦═════════╦══════════════╦═════════════╗
                                 {white}║ {red}Hacking Tool{white} ║ {red}Ip Tool{white} ║ {red}Discord Tool{white} ║ {red}Roblox Tool{white} ║ 
                                 {white}╚══════════════╩═════════╩══════════════╩═════════════╝  
   {page}
""")
   choice = input(f"""{red}┌───({white}{username_pc}@tempyultimatetools{red})─[{white}~{red}]
└──{white}$ {reset}""")
